...
export const Shop = new SimpleSchema({
  ...
  "defaultAdminRoles": {   
    type: [String],   
    defaultValue: ["owner", "admin", "guest", "account/profile"]    
  },    
  "defaultSupervisorRoles":{    
    type: [String],   
    defaultValue: [ "account/profile", "guest", "product", "tag", "index", "cart/checkout", "cart/completed", "reaction-checkout", "reaction-accounts",  "reaction-orders", "orders", "dashboard/orders", "dashboard/pdf/orders", "reaction-dashboard", "dashboard", "shopSettings" ]     
  },
  "defaultVisitorRole": {
    type: [String],
